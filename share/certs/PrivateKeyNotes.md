...
unlocked to sign the GleecBTC-Qt.app bundle.
...
allowing somebody to distribute a GleecBTC-Qt.app or gleecbtc-qt-setup.exe with a valid
...
that the gleecbtc-qt.exe file inside the installer had not been tampered with.
