// Copyright (c) 2018-2020 The GleecBTC Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef GLEECBTC_INTERFACES_CHAIN_H
#define GLEECBTC_INTERFACES_CHAIN_H
...
//! internal workings of the gleecbtc node, and not being very convenient to use.
...
//!   asynchronously
//!   (https://github.com/gleecbtc/gleecbtc/pull/10973#issuecomment-380101269).
//!
//! * The initMessages() and loadWallet() methods which the wallet uses to send
//!   notifications to the GUI should go away when GUI and wallet can directly
//!   communicate with each other without going through the node
//!   (https://github.com/gleecbtc/gleecbtc/pull/15288#discussion_r253321096).
//!
...
#endif // GLEECBTC_INTERFACES_CHAIN_H
