...
#ifndef GLEECBTC_INTERFACES_NODE_H
#define GLEECBTC_INTERFACES_NODE_H
...
//! Top-level interface for a gleecbtc node (gleecbtcd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // GLEECBTC_INTERFACES_NODE_H
