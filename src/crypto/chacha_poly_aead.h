...
#ifndef GLEECBTC_CRYPTO_CHACHA_POLY_AEAD_H
#define GLEECBTC_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@gleecbtc.
 *
 ...
 *
 * The chacha20-poly1305@gleecbtc combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@gleecbtc cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@gleecbtc are relatively fast in
...
#endif // GLEECBTC_CRYPTO_CHACHA_POLY_AEAD_H
