...
#error Client version information missing: version is not defined by gleecbtc-config.h or in any other way
#endif
...
/**
 * gleecbtcd-res.rc includes this file, but it cannot cope with real c++ code.
