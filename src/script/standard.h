...
#ifndef GLEECBTC_SCRIPT_STANDARD_H
#define GLEECBTC_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a gleecbtc address
 */
...
/**
 * Generate a GleecBTC scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // GLEECBTC_SCRIPT_STANDARD_H
