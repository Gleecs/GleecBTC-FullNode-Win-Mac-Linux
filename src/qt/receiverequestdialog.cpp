...
#include <config/gleecbtc-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatGleecBTCURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + GleecBTCUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatGleecBTCURI(info));
}
