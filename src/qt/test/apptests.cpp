...
//! Entry point for GleecBTCApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &GleecBTCApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for GleecBTCGUI tests.
void AppTests::guiTests(GleecBTCGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &GleecBTCGUI::consoleShown, this, &AppTests::consoleTests);
