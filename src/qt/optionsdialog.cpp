    ...
    mapper(nullptr)
{
    ...
    ui->gleecbtcAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->gleecbtcAtStartup);
    ...
    ui->gleecbtcAtStartup->setToolTip(ui->gleecbtcAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->gleecbtcAtStartup->setText(ui->gleecbtcAtStartup->text().arg(PACKAGE_NAME));

    ui->openGleecBTCConfButton->setToolTip(ui->openGleecBTCConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new GleecBTCUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->gleecbtcAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openGleecBTCConfButton_clicked()
{
