...
void WalletView::setGleecBTCGUI(GleecBTCGUI *gui)
{
    if (gui)
    {
        ...
        connect(overviewPage, &OverviewPage::transactionClicked, gui, &GleecBTCGUI::gotoHistoryPage);

        // Navigate to transaction history page after send
        connect(sendCoinsPage, &SendCoinsDialog::coinsSent, gui, &GleecBTCGUI::gotoHistoryPage);
        ...
        connect(this, &WalletView::encryptionStatusChanged, gui, &GleecBTCGUI::updateWalletStatus);

        // Pass through transaction notifications
        connect(this, &WalletView::incomingTransaction, gui, &GleecBTCGUI::incomingTransaction);

        // Connect HD enabled state signal
        connect(this, &WalletView::hdEnabledStatusChanged, gui, &GleecBTCGUI::updateWalletStatus);
    }
}
