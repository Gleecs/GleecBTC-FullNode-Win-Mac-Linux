...
#ifndef GLEECGBC_QT_GLEECGBCUNITS_H
#define GLEECGBC_QT_GLEECGBCUNITS_H
...
/** GleecBTC unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GleecBTCUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GleecBTCUnits(QObject* parent);

    /** GleecBTC units.
      @note Source: https://en.gleecbtc.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        GBC,
        mGBC,
...
typedef GleecBTCUnits::Unit GleecBTCUnit;

#endif // GLEECGBC_QT_GLEECGBCUNITS_H
