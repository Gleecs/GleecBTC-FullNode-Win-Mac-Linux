...
#ifndef GLEECGBC_TEST_SCRIPTNUM10_H
#define GLEECGBC_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from GleecBTC Core 0.10.0, for cross-comparison.
 */
public:
