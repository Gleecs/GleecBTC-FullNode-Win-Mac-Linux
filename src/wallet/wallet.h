...
#ifndef GLEECBTC_WALLET_WALLET_H
#define GLEECBTC_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! gleecbtc from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The GleecBTC Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this gleecbtc node, and set to 0 for transactions that were created
...
#endif // GLEECBTC_WALLET_WALLET_H
