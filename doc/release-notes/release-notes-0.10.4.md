GleecBTC Core version 0.10.4 is now available from:

  <https://gleecbtc.org/bin/gleecbtc-core-0.10.4/>
...
- #6953 `43c2789` Split gleecbtc-tx into its own package
- #6953 `dfe0d4d` Include gleecbtc-tx binary on Debian/Ubuntu
