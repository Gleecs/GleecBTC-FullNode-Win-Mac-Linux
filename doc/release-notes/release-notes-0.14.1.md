GleecBTC Core version 0.14.1 is now available from:

  <https://gleecbtc.org/bin/gleecbtc-core-0.14.1/>
...
here:
[reducing-gleecbtcd-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` gleecbtc-tx input verification (awemany, jnewbery)
