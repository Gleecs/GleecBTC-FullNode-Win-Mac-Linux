GleecBTC version 0.5.4 is now available for download at:
http://sourceforge.net/projects/gleecbtc/files/GleecBTC/gleecbtc-0.5.4/
...
http://gitorious.org/gleecbtc/gleecbtcd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix GleecBTC-Qt notifications under Growl 1.3.
Increase required age of GleecBTC-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGleecBTC properly when installing GleecBTC-Qt over it. (Windows)
