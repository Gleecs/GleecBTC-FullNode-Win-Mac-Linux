GleecBTC Core version 0.9.2.1 is now available from:

  https://gleecbtc.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 GLEEC to 0.01 GLEEC
...
- Fix "Start gleecbtc on system login"
