GleecBTC Core version 0.9.4 is now available from:

  https://gleecbtc.org/bin/0.9.4/
...
this update is incompatible with the GleecBTC system and could lead to consensus
forks.

GleecBTC Core released binaries from https://gleecbtc.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~gleecbtc/+archive/ubuntu/gleecbtc
- A third-party or self-compiled GleecBTC Core

upgrade to GleecBTC Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
