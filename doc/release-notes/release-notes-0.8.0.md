GleecBTC-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/gleecbtc/files/GleecBTC/gleecbtc-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the GleecBTC
...
New/changed settings (command-line or gleecbtc.conf file)
--------------------------------------------------------
