GleecBTC Core version 0.10.3 is now available from:

  <https://gleecbtc.org/bin/gleecbtc-core-0.10.3/>
...
(see https://github.com/gleecbtc/gleecbtc/pull/6793, as well as the 0.11.0
