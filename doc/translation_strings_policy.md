...
This document provides guidelines for internationalization of the GleecBTC Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `gleecbtc_en.ts` remains unchanged.
