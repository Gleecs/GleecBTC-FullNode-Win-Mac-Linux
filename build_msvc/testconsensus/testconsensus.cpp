...
// gleecbtc includes.
#include <..\src\script\gleecbtcconsensus.h>
...
int main()
{
    std::cout << "gleecbtcconsensus version: " << gleecbtcconsensus_version() << std::endl;
    ...
    auto op0Result = gleecbtcconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, gleecbtcconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
