...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the gleecbtc repository."
  exit 1
fi
...
# See https://github.com/gleecbtc/gleecbtc/issues/16064
...
echo 'When compiling gleecbtcd, run `./configure` in the following way:'
echo
