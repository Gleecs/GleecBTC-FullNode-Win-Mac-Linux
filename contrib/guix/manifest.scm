...
(define* (make-gleecbtc-cross-toolchain target
                                  #:key
...
desirable for building GleecBTC Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-gleecbtc-cross-toolchain "i686-linux-gnu")
       (make-gleecbtc-cross-toolchain "x86_64-linux-gnu")
       (make-gleecbtc-cross-toolchain "aarch64-linux-gnu")
       (make-gleecbtc-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-gleecbtc-cross-toolchain "riscv64-linux-gnu"
