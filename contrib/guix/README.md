# Bootstrappable GleecBTC Core Builds

This directory contains the files necessary to perform bootstrappable GleecBTC
Core builds.
...
- 24GB of free disk space on the partition that the GleecBTC Core git repository
  resides in
...
For a GleecBTC Core depends development environment, simply invoke
...
From the top of a clean GleecBTC Core repository:
...
To use dongcarl's substitute server for GleecBTC Core builds after having
