...
class BIP66Test(GleecBTCTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # gleecbtcd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and gleecbtcd produces more specific reject
            # reasons.
