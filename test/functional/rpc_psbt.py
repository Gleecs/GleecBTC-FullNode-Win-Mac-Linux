...
class PSBTTest(GleecBTCTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 GLEEC
        ...
        # feeRate of 0.1 GLEEC / KB produces a total fee slightly below -maxtxfee (~0.05280000):
        ...
        # feeRate of 10 GLEEC / KB produces a total fee well above -maxtxfee
