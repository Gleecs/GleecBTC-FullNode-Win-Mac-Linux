...
"""Verify that starting gleecbtc with -h works as expected."""

from test_framework.test_framework import GleecBTCTestFramework
from test_framework.util import assert_equal

class HelpTest(GleecBTCTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gleecbtc with -h for help text")
        ...
        self.log.info("Start gleecbtc with -version for version information")
        ...
        self.log.info("Start gleecbtcd with -fakearg to make sure it does not start")
