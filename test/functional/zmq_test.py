...
from test_framework.test_framework import GleecBTCTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (GleecBTCTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that gleecbtc has been built with ZMQ enabled
