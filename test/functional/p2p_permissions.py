...
class P2PPermissionsTests(GleecBTCTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].gleecbtcconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].gleecbtcconf, 'w', encoding="utf8") as f:
            f.write(newText)
